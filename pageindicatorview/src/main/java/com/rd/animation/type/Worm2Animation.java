...
public class Worm2Animation extends BaseAnimation<AnimatorSet> {
    ...
    @Override
    public Worm2Animation duration(long duration) {
        super.duration(duration);
        return this;
    }

    public Worm2Animation with(int coordinateStart, int coordinateEnd, int radius, boolean isRightSide) {
    ...
    @Override
    public Worm2Animation progress(float progress) {
        if (animator == null) {
            return this;
        }
